...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/broad-sound-5db5
```

A live public deployment of this template is available at [https://broad-sound-5db5.templates.workers.dev](https://broad-sound-5db5.templates.workers.dev)
